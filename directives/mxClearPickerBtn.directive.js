(function(w) {
    ...
    function mxClearPickerBtn($parse, $compile) {
        ...
        function link(scope, element, attrs) {
            ...
            var template = [
                '<md-button ng-hide="vm.disabled || vm.readOnly" tabindex="-1" ng-class="(vm.browseLookup && vm.selectedItem) ? \'clear-autocomplete--offset\' : \'\' " class="md-icon-button clear-autocomplete">',
